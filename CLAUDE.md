...
3. Update the service worker cache version in `sw.js` if any cached files changed. Current version: `gymops-v73`. New JS files must be added to the `ASSETS` list in `sw.js` or offline mode breaks.
