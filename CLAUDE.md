...
## Phase 5 Status
✅ **CORE COMPLETE** (July 22, 2026, SW cache: `gymops-v87`, app: `v5.10`) — 5.1–5.6 shipped: exercise IDs, multi-day programs, feedback batch, start chooser, quick-log hero, IndexedDB storage, adherence rework. ⚠️ **Closeout open** — **5.7 + 5.8 shipped**. Full list + working order in `docs/PHASE4_CONSUMER_PLAN.md` § Phase 5 closeout backlog. Remaining core closeout = **5.9**; should-do 5.10/5.12; optional 5.11. Aliases stay with **6.2**, not Phase 5.
...
- [ ] **5.9 Docs closeout** — BACKLOG (after 5.7). Tick remaining success criteria; mark Phase 5 fully complete; aliases → 6.2.
