...
- [ ] **6.2 Strong / Hevy CSV import** — IN PROGRESS July 26, 2026 (branch `feature/6.2-import`, app: `v6.7`, SW cache: `gymops-v95`). Data layer + flow UI built and browser-verified; not yet merged. Three new modules, all in `sw.js` ASSETS.
  ...
  - 46 new tests across `aliases` / `import` / `import-write` (233 total), fixtures byte-faithful to real exports. Browser-verified at 375px: unit guard, preview, candidate choice, import, **undo**, and re-import-skips-duplicates. **Remaining: first-run entry point** (6.1's card can carry it) and a merge/rename affordance for names kept as new.
